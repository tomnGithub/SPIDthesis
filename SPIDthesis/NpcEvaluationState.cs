...
internal sealed class NpcEvaluationState
{
    ...
    private readonly bool _enableTemplateHandling;
    ...
    private NpcEvaluationState(
        ...
        RecordIndex index,
        INpcGetter source,
        bool enableTemplateHandling)
    {
        _state = state;
        _index = index;
        _enableTemplateHandling = enableTemplateHandling;
        Source = source;
    }
    ...
    public static NpcEvaluationState Create(
        ...
        bool enableTemplateHandling)
    {
        var result = new NpcEvaluationState(state, index, source, enableTemplateHandling);
        result.Build();
        return result;
    }
    ...
    private void Build()
    {
        ...
        {
            TemplateChain.Add(Source);
            MatchNpcSources.Add(Source);
            BuildDirectLists();
        }
    ...
    private void BuildStaticFields()
    {
        ...
        Leveled = _enableTemplateHandling && IsLeveledTemplate(Source);

        // With template handling enabled, use the union of reachable NPC/template branches for static
        // matching. Otherwise MatchNpcSources contains only the winning NPC record.
